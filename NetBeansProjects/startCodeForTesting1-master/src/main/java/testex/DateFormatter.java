...
public class DateFormatter implements IDateFormatter {
    ...
    */
    ...
    // Writting testable code - avoid static methods 
    // Writting testable code - Dependency injections is our friend 
    //                          Instead of initilization, inject Date object
    //                          as parameter
    ...
    public static void main(String[] args) throws JokeException {
        ...
        System.out.println(new DateFormatter().getFormattedDate("Europe/Copenhagen", new Date()));
