...
import testex.jokefetch.FetcherFactory;
...
public class JokeFetcher {
    ...
    public Jokes getJokes(String jokesToFetch, String timeZone) throws JokeException {
        ...
        String timeZoneString = IDateformatter.getFormattedDate(timeZone, new Date());
    ...
    public static void main(String[] args) throws JokeException {
        JokeFetcher jokeFetcher = new JokeFetcher(new DateFormatter(), new FetcherFactory());
        ...
        System.out.println("Is String Valid: " + jokeFetcher.isStringValid("edu_prog,xxx"));
    }
}
